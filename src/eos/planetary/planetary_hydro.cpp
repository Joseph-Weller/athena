...
//!                                                 int i)
//! \brief Apply density and specific internal energy floors to reconstructed L/R cell
//! interface states
...
void EquationOfState::ApplyPrimitiveFloors(AthenaArray<Real> &prim, int k, int j, int i) {
  ...
  // apply specific internal energy floor
  w_e = (w_e > espec_floor_) ?  w_e : espec_floor_;
...
void EquationOfState::ApplyPrimitiveConservedFloors( AthenaArray<Real> &prim,
  ...
  u_e = (w_e > espec_floor_) ? u_e : w_d*espec_floor_ + e_k;
  w_e = (w_e > espec_floor_) ? w_e : espec_floor_;
